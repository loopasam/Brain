...
a series of concepts described below.
...
stored locally or via a network but Brain will always merge the added information to the existing ontology.
\subsection{Unique names}
The names of OWL entities handled by a Brain object have to be unique. This choice is 
is motivated by the fact that Brain hides as much as possible the cumbersome interaction with prefixes,
IRI and URIs.
