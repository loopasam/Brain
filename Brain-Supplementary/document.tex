...
\begin{table}[h]
\caption{Comparison SQL vs OWL}
\centering
{\begin{tabular}{c|c|c}
\hline\hline

 & \textbf{Relational Model (SQL)} & \textbf{OWL (via Brain)} \\ \hline

\begin{tabular}[c]{@{}c@{}}
Query: \\ regulators of 'blood coagulation'
\end{tabular} &
...
AND distance \textless \textgreater \vspace{} 0 ;\\ 
\end{tabular} &
\begin{tabular}[c]{@{}c@{}}
